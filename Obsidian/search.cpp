...
namespace Search {
  ...
  DEFINE_PARAM_S(LmrBase, 40, 10);
  DEFINE_PARAM_S(LmrDiv, 195, 10);

  DEFINE_PARAM_S(StatBonusLinear, 136, 10);
  DEFINE_PARAM_S(StatBonusMax, 1159, 50);
  DEFINE_PARAM_S(StatBonusBoostAt, 123, 10);

  DEFINE_PARAM_S(RazoringDepthMul, 412, 10);

  DEFINE_PARAM_S(RfpMaxDepth, 8, 1);
  DEFINE_PARAM_S(RfpDepthMul, 121, 6);

  DEFINE_PARAM_S(NmpBase, 4, 1);
  DEFINE_PARAM_B(NmpDepthDiv, 4, 1, 21);
  DEFINE_PARAM_S(NmpEvalDiv, 197, 20);
  DEFINE_PARAM_S(NmpEvalDivMin, 4, 1);

  DEFINE_PARAM_S(ProbcutBetaMargin, 231, 10);
  ...
  DEFINE_PARAM_S(EarlyLmrHistoryDiv, 5413, 300);
  ...
  DEFINE_PARAM_S(LmrQuietHistoryDiv, 10309, 300);
  DEFINE_PARAM_S(LmrCapHistoryDiv, 8069, 300);
  DEFINE_PARAM_S(ZwsDeeperMargin, 79, 5);

  DEFINE_PARAM_B(AspWindowStartDepth, 4, 4, 34);
  DEFINE_PARAM_B(AspWindowStartDelta, 10, 5, 45);
