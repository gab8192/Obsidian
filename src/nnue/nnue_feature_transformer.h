...
namespace Stockfish::Eval::NNUE {
  ...
  extern Accumulator superAccumulator;
  ...
  class FeatureTransformer {
   ...
   public:
    ...
    std::int32_t transform(const Position& pos, OutputType* output, int bucket) const {
      update_accumulator_refresh<WHITE>(pos);
      update_accumulator_refresh<BLACK>(pos);

      const Color perspectives[2] = {pos.sideToMove, ~pos.sideToMove};
      const auto& accumulation = superAccumulator.accumulation;
      const auto& psqtAccumulation = superAccumulator.psqtAccumulation;
   ...
   private:
    ...
    void update_accumulator_refresh(const Position& pos) const {
      ...
      auto& accumulator = superAccumulator;
